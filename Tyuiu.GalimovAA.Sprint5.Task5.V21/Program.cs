...
namespace Tyuiu.GalimovAA.Sprint5.Task5.V21
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Дан файл с набором значений. Найти факториал наибольшего целого числа,  *");
            Console.WriteLine("* которое делится на 2, в файле. Результат вывести на консоль.            *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
